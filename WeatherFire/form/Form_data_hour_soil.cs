...
{
    public partial class Form_data_hour_soil : Form
    {
        ...
        public Form_data_hour_soil()
        {
            ...
            using (MySqlDataAdapter myDa = new MySqlDataAdapter("select CP_Data_StationID,CP_Data_DateTime,CP_Data_Tuwen,CP_Data_Tushi,CP_Data_Tuyan1,CP_Data_Tuwen2,CP_Data_Tushi2,CP_Data_Tuyan2,CP_Data_Tuwen3,CP_Data_Tushi3,CP_Data_Tuyan3,CP_Data_Tuwen4,CP_Data_Tushi4,CP_Data_Tuyan4 from cp_sensor_data_hour where CP_Data_DateTime>='" + dt_Start + "' and  CP_Data_DateTime<='" + dt_Stop + "' order by CP_Data_DateTime desc", conn))
            {
